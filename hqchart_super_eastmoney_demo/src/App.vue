  ...
  <div class="box">
    ...
    <div class="right" ref="right">
      <div class="rightTab" ref="rightTab">
        <div
          class="btn showMinute"
          :class="{ active: chartType == 'minute' }"
          @click="changeRightContent('minute')"
        >
          分时图
        </div>
        <div
          ...
          @click="changeRightContent('kline')"
        >
          K线图
        </div>
      </div>
...
export default {
  ...
  methods: {
    OnSize() {
      ...
      var chartHeight =
        window.innerHeight -
        rightTab.offsetHeight -
        periodWrap.offsetHeight -
        indexWrap.offsetHeight -
        statementWrap.offsetHeight;
